...
set :application, "curator.io"
set :user, "curatorio"
set :repository, "git@github.com:matthiasmullie/curator.io.git"				
set :document_root, "/home/curatorio/domains/curator.io/public_html"

set :deploy_to, "/home/#{user}/apps/#{application}"
server "91.220.37.164", :app, :web, :db, :primary => true
set :scm, :git
